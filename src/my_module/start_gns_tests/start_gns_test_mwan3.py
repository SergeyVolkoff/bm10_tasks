...
console.print("Стартует сброс DUT перед настройкой под тест mwan3\n" ,style='info')
time.sleep(5)
with open("../command_cfg/value_bm10.yaml")as f:
    ...
    for t in temp:
        device = dict(t)
        r1 = Cfg_bm10(**device)
        with open("../command_cfg/commands_reset_cfg.yaml") as f14:                # команды настройки mwan3
        ...
        with open("../command_cfg/value_bm10.yaml")as f:
                ...
                for t in temp:
                    ...
                    print(r1.cfg_mwan3(device,command_cfg_mwan))    # Настройка DUT
